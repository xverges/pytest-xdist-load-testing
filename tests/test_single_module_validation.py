...
def test_single_module_accepted(pytester):
    ...
    result = pytester.runpytest('--load-test', '-n', '2')
...
def test_multiple_modules_rejected(pytester):
    ...
    result = pytester.runpytest('--load-test', '-n', '2', 'test_module1.py', 'test_module2.py')
...
def test_multiple_modules_in_directory_rejected(pytester):
...
def test_single_module_with_classes(pytester):
